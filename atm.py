...
root.title("ATM MACHINE BY TANISHKA")
...
lblinfo=  Label (Tops,font=('aria',30,'bold'),text="ATM MACHINE BY TANISHKA", fg="Powder Blue", bg="black", bd=10, anchor='w' )
...
def bank():
    ...
    if account in accno:
        ...
        label.config(text="Non-Registerd Member")
...
txt =Entry(f1,font=('aria',16,'bold'), textvariable=number,bd=6,insertwidth=4,bg="Powder Blue",justify='right')
txt.grid(row=0,column=4)
label = Label(f1, fg="white",bg="black",font=('aria',16,'bold'))
label.grid(row=1,column=4)
btnsubmit = Button(f2,padx=16,pady=4,bd=10,fg="black",font=('area',16,'bold'), width=7, text="SUBMIT", bg="Powder Blue", command=bank)
...
text =Entry(f1,font=('aria',16,'bold'), textvariable=amount,bd=6,insertwidth=4,bg="Powder Blue",justify='right')
text.grid(row=4,column=4)
label3= Label(f1, fg="white",bg="black",font=('aria',16,'bold'))
label3.grid(row=5,column=4)
btndeposit = Button(f2,padx=16,pady=4,bd=10,fg="black",font=('area',16,'bold'), width=7, text="SUBMIT", bg="Powder Blue", command=deposit)
...
text =Entry(f1,font=('aria',16,'bold'), textvariable=withd,bd=6,insertwidth=4,bg="Powder Blue",justify='right')
